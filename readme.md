...
업로드해주신 파일을 확인해 보니 마크다운 코드 블록(```cmd)이 닫히지 않은 상태로 잘려 있네요!

잘린 부분부터 파일의 끝까지, 이전에 작성했던 완벽한 마크다운 문법을 그대로 적용하여 나머지 내용을 작성해 드립니다. 아래 내용을 복사해서 잘린 부분 밑에 그대로 붙여넣으시면 됩니다.
